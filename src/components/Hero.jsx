        ...
        <>
            <div className='flex items-center flex-col space-y-3' id="home">
                <div className='w-[250px] h-[250px] md:w-[300px] max-auto md:h-[300px] mt-10 mb-2'>
                    <img src='../../public/assets/profile-pic.png' alt="profile" className='w-full h-full rounded-full' />
                </div>
                ...
                <div className='flex space-y-5 space-x-0 md:space-y-0 md:space-x-5 flex-col md:flex-row items-center md:justify-between text-md mb-5 text-center w-[80%] md:w-auto *:w-full md:*:w-fit'>
                    ...
                    <a href="../../public/assets/my_resume.pdf" download="Bilal Benyoussef's Resume" type="button" className='font-semibold shrink-0 px-5 py-2.5 text-xs rounded-3xl border-2 border-white hover:border-2 hover:border-[#B415FF]'>My Resume</a>
                </div>
            </div>
            <ToastContainer
                position='top-center'
