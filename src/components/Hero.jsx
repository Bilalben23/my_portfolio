...
export default function Hero() {
    return (
        <div className='flex items-center flex-col space-y-3' id="home">
            ...
            <div className='flex space-y-5 space-x-0 md:space-y-0 md:space-x-5 flex-col md:flex-row items-center md:justify-between text-md mb-5 w-1/2 md:w-auto *:w-full md:*:w-fit'>
