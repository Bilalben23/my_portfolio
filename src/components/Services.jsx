...
export default function Services() {
    return (
        <div className='mb-[80px] flex flex-col justify-center w-[90%] sm:w-[95%] mx-auto' id='services'>
...
function ServiceCard({ service }) {
    return (
        <div className='p-5 border-2 rounded-md cursor-pointer flex flex-col justify-center transition hover:scale-[1.02] hover:border-[#ff00ff] hover:bg-card-gradient'>
            ...
            <p className='text-md md:text-lg font-bold text-transparent bg-clip-text bg-text-bg'>{service.s_name}</p>
